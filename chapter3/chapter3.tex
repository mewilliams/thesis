...
\begin{subfigure}{.5\textwith}
	\centering
	\includegraphics[width=.8\linewidth]{chapter3/figures/figure1b_ed2.tif}
	\caption{1b}
...
\begin{figure}
\includegraphics{chapter3/figures/figure3_3day.pdf}
...
%%%%% NEEDS SUBFIGURES!!%%%%%%%%%%
\begin{figure}
\includegraphics{chapter3/figures/fig4_onetide_ADV.pdf}
\includegraphics{chapter3/figures/fig4_zoomed_ADV.pdf}
...
\begin{figure}
\includegraphics[width=18cm]{chapter3/figures/fig5_vps_U_P_edited.pdf}
...
%%%%% NEEDS SUBFIGURES!!%%%%%%%%%%
\begin{figure}
\includegraphics{chapter3/figures/figure7_alternate.pdf}
\includegraphics{chapter3/figures/figure7d_wavesetup_swh_vs_setup.pdf}\protect\caption{The relation between ocean water level and estuarine water level depends
...
\includegraphics[scale=0.6]{figures/f_extra_FC_cd.pdf}
...
\begin{figure}
\includegraphics{chapter3/figures/mouth_yz_schematic.pdf}\protect\caption{At low water, the inlet tends to be channelized and flow is laterally
...
%%%%%%% NEEDS SUBFIGURES!!%%%%%%%%%%
\begin{figure}
\includegraphics[width=17cm]{chapter3/figures/figure_saltprofile_xz_edited.pdf}

\includegraphics[width=16cm]{chapter3/figures/figure_saltprofile_h_u_t.pdf}
...
\begin{figure}
\includegraphics[width=19cm]{chapter3/figures/figure9_z_t_salt_vel_shear_wcb_edited.pdf}
