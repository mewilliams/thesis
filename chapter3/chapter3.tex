...
\citealp{mei_surface_1993,battjes_surf-zone_1988}). Wave setup observed in lagoonal
estuaries {[}e.g. \citealp{malhadas_effect_2009}{]} may be analogous
to similar setup on coral reef lagoons {[}e.g. \citealp{becker_water_2014}{]}
and wave-driven flow on these reefs \citep{monismith_hydrodynamics_2007} may also
...
period from 30 s to 5 min, consistent with Munk \citeyearpar{munk_origin_1950}.
...
present on sandy beaches \citep{contardo_infragravity_2013} and we expect
...
{[}e.g. \citealp{ralston_effects_2013}{]}. The analytical description
...
As observed in other coastal lagoons {[}e.g. \citealp{malhadas_effect_2009}{]},
...
A typical value for $c_{D}$ of a sandy bed is 0.004 \citep{soulsby_bottom_1983}
and this value has been observationally recorded in inlets to tidal
lagoons \citep{rydberg_tidal_1996}. Bedforms at the mouth of
...
lagoon in tidally choked systems {[}e.g. \citealp{rydberg_tidal_1996,hill_fortnightly_1994}{]}
 based on the formulation \emph{$\left|h_{o}-h_{i}\right|=\left(1+\frac{C_{D}BL}{A}\right)\frac{u^{2}}{2g}$}
\citep{stigebrandt_aspects_1980}. This formulation expects water
...
Spain \citep{uncles_infragravity_2014}. Work focused on wave-current interaction
...
velocities \citep{dodet_wave-current_2013}. Elsewhere in California, surface
...
presence of infragravity motions on beaches worldwide \citep{contardo_infragravity_2013}
...
the sand berm grows \citep{beach_suspended_1988,green_processes_2001,baldock_morphodynamic_2008}.
...
of other estuaries \citep{baldock_morphodynamic_2008}.
...
drives gravitational circulation, a constant subtidal exchange \citep{maccready_advances_2010}.
