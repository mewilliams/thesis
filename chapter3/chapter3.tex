\chapter{tidally discontinuous estuarine forcing chapter}
\label{chCirculation}
...
As observed in other coastal lagoons {[}e.g. \citealp{malhadas_etal_2009}{]},
...
\subsubsection{Of infragravity time scale processes}
...
of drag, $c_{D}$, for the frictionally controlled state, accurate
...
s\textsuperscript{-1} and $h_{DC}=1.45$ m give a range of $c_{D}$
from 0.014 to 0.14. Characteristic late frictional control values
of $\overline{{u}}{}_{DC}=-0.2$ m s\textsuperscript{-1} and $h_{DC}=1$
m give a range of $c_{D}$ from 0.002 to 0.02.

A typical value for $c_{D}$ of a sandy bed is 0.004 \citep{soulsby_1983}
and this value has been observationally recorded in inlets to tidal
lagoons \citep{rydberg_and_wickbom_1996}. Bedforms at the mouth of
the Pescadero estuary probably increase the drag above $c_{D}$ =
...
lagoon in tidally choked systems {[}e.g. \citealp{rydberg_and_wickbom_1996,hill_1994}{]}
 based on the formulation \emph{$\left|h_{o}-h_{i}\right|=\left(1+\frac{C_{D}BL}{A}\right)\frac{u^{2}}{2g}$}
\citep{stigebrandt_1980}. This formulation expects water
...
Spain \citep{uncles_etal_2014}. Work focused on wave-current interaction
...
velocities \citep{dodet_etal_2013}. Elsewhere in California, surface
...
presence of infragravity motions on beaches worldwide \citep{contardo_and_symonds}
...
In larger, density stratified estuaries, such as the Russian River
...
the sand berm grows \citep{beach_sternberg_1988,green_macdonald_2001,baldock_etal_2008}.
...
of other estuaries \citep{baldock_etal_2008}.
...
drives gravitational circulation, a constant subtidal exchange \citep{maccready_geyer_2010}.
...
\begin{thebibliography}{\textit{Ranasinghe and Patttiaratchi}(2003)}
\bibitem[\textit{Baldock et al.}(2008)]{baldock_etal_2008}Baldock,
...
\bibitem[\textit{Battjes}(1988)]{battjes_1988}Battjes, J. A. (1988),
Surf-zone dynamics, \emph{Annu. Rev. Fluid Mech.}, 20(1), 257\textendash 291,
doi:10.1146/annurev.fl.20.010188.001353. 

\bibitem[\textit{Beach and Sternberg}(1988)]{beach_sternberg_1988}Beach,
...
\bibitem[\textit{Becker et al.}(2014)]{becker_etal_2014}Becker, J.M.,
...
\bibitem[\textit{Behrens et al.}(2013)]{behrens_etal_2013}Behrens,
...
\bibitem[\textit{Contardo and Symonds}(2013)]{contardo_and_symonds}Contardo,
...
\bibitem[\textit{Dodet et al.}(2013)]{dodet_etal_2013}Dodet, G.,
...
\bibitem[\textit{Elwany et al.}(1998)]{elwany_etal_1998}Elwany, M.
H. S., R. E. Flick, and S. Aijaz (1998), Opening and closure of a
marginal Southern California lagoon inlet, \emph{Estuaries}, 21(2),
246\textendash 254. 

\bibitem[\textit{Fortunato et al.}(2014)]{fortunato_etal_2014}Fortunato,
...
\bibitem[\textit{Gale et al.}(2007)]{gale_etal_2007}Gale, E., C.
...
\bibitem[\textit{Green and MacDonald}(2001)]{green_macdonald_2001}Green,
...
\bibitem[\textit{Hanes et al.}(2011)]{hanes_etal_2011}Hanes, D. M.,
...
\bibitem[\textit{Hill}(1994)]{hill_1994}Hill, A. E. (1994), Fortnightly
tides in a lagoon with variable choking, \emph{Estuar. Coast. Shelf
Sci}., 38(4), 423\textendash 434, doi:10.1006/ecss.1994.1029. 

\bibitem[\textit{Largier and Taljaard}(1991)]{largier_and_taljaard_1991}Largier,
...
\bibitem[\textit{MacCready and Geyer}(2010)]{maccready_geyer_2010}MacCready,
...
\bibitem[\textit{Malhadas et al.}(2009)]{malhadas_etal_2009}Malhadas,
...
\bibitem[\textit{Mei and Liu}(1993)]{mei_liu_1993}Mei, C. C., and
...
\bibitem[\textit{Monismith}(2007)]{monismith_2007}Monismith, S. G.
...
\bibitem[\textit{Munk}(1950)]{munk_1950}Munk, W. H. (1950), Origin
and generation of waves, \emph{Int. Conf. Coastal. Eng.}, 1(1), 1,
doi:10.9753/icce.v1.1. 

\bibitem[\textit{Ralston et al.}(2013)]{ralston_etal_2013}Ralston,
...
\bibitem[\textit{Ranasinghe and Pattiaratchi}(1999)]{ranasinghe_pattiaratchi_1999}Ranasinghe,
...
\bibitem[\textit{Ranasinghe and Patttiaratchi}(2003)]{ranasinghe_pattiaratchi_2003}Ranasinghe,
...
\bibitem[\textit{Rydberg and Wickbom}(1996)]{rydberg_and_wickbom_1996}Rydberg,
...
\bibitem[\textit{Schubert and Bokuniewicz}(1991)]{schubert_bokuniewicz_1991}Schubert,
...
\bibitem[\textit{Sharples et al.}(2003)]{sharples_etal_2003}Sharples,
...
\bibitem[\textit{Simpson et al.}(2004)]{simpson_etal_2004}Simpson,
...
\bibitem[\textit{Soulsby}(1983)]{soulsby_1983}Soulsby, R. L. (1983),
...
\bibitem[\textit{Stigebrandt}(1980)]{stigebrandt_1980}Stigebrandt,
...
\bibitem[\textit{Uncles et al.}(2014)]{uncles_etal_2014}Uncles, R.
...
\bibitem[\textit{Wolanski et al.}(2004)]{wolanski_etal_2004}Wolanski,
...
\begin{figure}[t]
\includegraphics{chapter3/img/fig1a.pdf}
\includegraphics[height=9cm]{chapter3/img/figure1b_ed2.tif}\\
...
\begin{figure}
\includegraphics{img/figure2_externalsensors}
...
\begin{figure}
\includegraphics{img/figure3_3day}
...
\begin{figure}
\includegraphics{img/figure0_schematic}
...
\begin{figure}
\includegraphics{img/fig4_onetide_ADV}

\includegraphics{img/fig4_zoomed_ADV}\protect\caption{Measurements from an ADV measuring 20 cm above the bed at the NM station.
...
\begin{figure}
\includegraphics[width=18cm]{img/fig5_vps_U_P_edited}
...
\begin{figure}
\includegraphics{img/figure7_alternate}\includegraphics{img/figure7d_wavesetup_swh_vs_setup}\protect\caption{The relation between ocean water level and estuarine water level depends
...
\begin{figure}
\includegraphics{img/figure8_u_h}

\includegraphics[scale=0.6]{img/f_extra_FC_cd}
...
\begin{figure}
\includegraphics{img/figure10_KE_all}\protect\caption{Velocity and kinetic energy measurements by the ADV at NM. Principle
...
\begin{figure}
\includegraphics{img/mouth_yz_schematic}\protect\caption{At low water, the inlet tends to be channelized and flow is laterally
...
\begin{figure}
\includegraphics[width=17cm]{img/figure_saltprofile_xz_edited}

\includegraphics[width=16cm]{img/figure_saltprofile_h_u_t}
...
\begin{figure}
\includegraphics[width=19cm]{img/figure9_z_t_salt_vel_shear_wcb_edited}
...
%
%\begin{table}[t]
%\caption{Magnitude of the terms from the longitudinal vorticity budget (\ref{omegaX budget}) %over the slope. The terms are given in $ 10^{-5}\, \mathrm{s^{-2}}$.}\label{t2}
%\begin{center}
%\begin{tabular}{ccccc}
%\hline\hline
%$Terms$ & & $T4$ & $T7$ & $T10$\\
%\hline
%$\partial \omega_x / \partial t$ & $\simeq$ & -1 & 2 & -2  \\
%$\partial / \partial z \left( v \partial v / \partial y \right)$ & $\simeq$ & 0.1 & 0.5 & 0.5  \\
%$f\partial u / \partial z $ & $\simeq$ & 0.5 & 1 & 0.5 \\
%$-g\beta \partial s / \partial y $ & $\simeq$ & -2 & 2 & -2 \\
%\hline
%\end{tabular}
%\end{center}
%\end{table}
