...
above \cite{largier_dynamics_1991}. Similar salt-wedge or two-layer
...
and wave-driven flow on these reefs \cite{monismith_hydrodynamics_2007} may also
...
present on sandy beaches \cite{contardo_infragravity_2013} and we expect
...
A typical value for $c_{D}$ of a sandy bed is 0.004 \cite{soulsby_bottom_1983}
and this value has been observationally recorded in inlets to tidal
lagoons \cite{rydberg_tidal_1996}. Bedforms at the mouth of
...
\cite{stigebrandt_aspects_1980}. This formulation expects water
...
Spain \cite{uncles_infragravity_2014}. Work focused on wave-current interaction
...
velocities \cite{dodet_wave-current_2013}. Elsewhere in California, surface
...
presence of infragravity motions on beaches worldwide \cite{contardo_infragravity_2013}
...
the sand berm grows \cite{beach_suspended_1988,green_processes_2001,baldock_morphodynamic_2008}.
...
of other estuaries \cite{baldock_morphodynamic_2008}.
...
tidal energy \cite{wolanski_undular_2004} while breaking tidal bores
contribute an energetic burst of turbulent kinetic energy (TKE) \cite{simpson_reynolds_2004}. The bore structure in the Pescadero estuary as the tide rises is usually undular but has been observed to be breaking when the ocean wave climate is very large. 
...
drives gravitational circulation, a constant subtidal exchange \cite{maccready_advances_2010}.
