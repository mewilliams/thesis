...
\includegraphics[width=.9\textwidth]{chapter2/figures/Qcfs_during_breach_nov2010}
\end{subfigure}
\begin{subfigure}{width=.5\linewidth}
\includegraphics[width=.9\textwidth]{chapter2/figures/Qcfs_during_breach_nov2011}
\end{subfigure}
\caption{Q} \label{fig:QbreachNov}
\end{figure}
