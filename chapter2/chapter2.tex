...
\begin{figure}
	...
	\end{subfigure} \caption{Freshwater streamflow into the estuary for Noverber 2010 and November 2011 breach events.} \label{fig:QbreachNov}
\end{figure}
