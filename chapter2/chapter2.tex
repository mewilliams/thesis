...
\begin{figure}
	%\begin{subfigure}{.5\textwidth}
		\includegraphics[width=\linewidth]{chapter2/figures/QTH_nov_breach}
	%\end{subfigure}
	%\begin{subfigure}{.5\textwidth}
%		\includegraphics[width=\linewidth]{chapter2/figures/QTH_nov2011}
%	\end{subfigure} 
