...
\centering
	...
	\caption{Sensors vertically distributed during the closed state in November 2010 show that the upper water column responsds to solar heating while the lower, stratified water column does not.} \label{fig:temp_and_strat}
\end{figure}
...
Of the events caputured, 20 February, 2012 is known to be an artificial breach, triggered by digging out sand at the mouth. The other events occurred during elevated freshwater discharge, so are more likely to be due to natural causes, but there is little certainty either way.
