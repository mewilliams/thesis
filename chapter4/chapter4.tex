...
Using this data, equation~\ref{eq:S} is fit and values of \emph{K$_x$} are calculated for the upper and lower salinities in the four tidal cycles (Figures~\ref{fig:Kx421}-~\ref{fig:Kx424}), and the results are tabuled in table \emph{(figure out how to label table)}. 
