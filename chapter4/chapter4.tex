...
\begin{figure}[h!]
\includegraphics[width=\textwidth]{chapter2/figures/fig0analyticalS}
\caption{Equation~\ref{eq:S} starts from a step function and smooths over time. In this graphic, the line grows lighter with increasing time.} \fig{fig:Sgraphic}
\end{figure}
