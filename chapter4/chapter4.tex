...
\renewcommand{\arraystretch}{1.3}
	...
	\begin{center}
		...
		\hline
		Date & S$_{T}$ & K$_{x,S=0 \rightarrow S_T}$ &  K$_{x,S=S_T \rightarrow S_0}$ & x$_{c,fresher}$ & x$_{c,fresher}$ & t$_{S=0 \rightarrow S_T}$ & t$_{S=S_T \rightarrow S_0}$\\
		\hline \hline
		21 Apr & 11.5 & 44.9 m$^2$ s$^{-1}$ & 2.2 m$^2$ s$^{-1}$ & -591 m & -9.4 m & 2.5x10$^4$ s & $2.1\times10^4$ s\\  
		22 Apr & 10.5 & 55.6 m$^2$ s$^{-1}$ & 2.9 m$^2$ s$^{-1}$ & -714 m & -60.2 m & 3.1x10$^4$ s & 2.4x10$^4$ s\\ 
		23 Apr & 14.4 & 28.3 m$^2$ s$^{-1}$ & 5.0 m$^2$ s$^{-1}$ & 34.2 m & 19.0 m & 3.1x10$^4$ s & 2.3x10$^4$ s\\ 
		24 Apr & 14.1 & 28.7 m$^2$ s$^{-1}$ & 5.7 m$^2$ s$^{-1}$ & -137 m & -3.9 m & 3.2x10$^4$ s & 2.4x10$^4$ s\\   \hline 
	\end{tabular}
