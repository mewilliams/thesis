...
\paragraph{closure papers} Inlet closure typically thought to be determined by the interaction of two processes: littoral drift which forces sand into a dynamic inlet, and tidal inlet flow (CITE). Davidson et al. \parencite*{davidson_simple_2009} also consider for the downslope diffusion of sediment... Littoral drift means .... Tidal flow asymmetries .... 
